...
namespace imageinpaint
{
    public partial class Form1 : Form
    {
        ...
        void draw(int patch,Tuple<int,int>pos) {
            int cnt = 0;
        ...
        public void solve() {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < boundary.Count; i++) {
                    ...
                    else if (boundary[i].Item2 - 1 >=0 && (inputimage.Data[boundary[i].Item1, boundary[i].Item2 - 1, 0] == 0 &&
                            inputimage.Data[boundary[i].Item1, boundary[i].Item2 - 1, 1] == 0 &&
                            inputimage.Data[boundary[i].Item1, boundary[i].Item2 - 1, 2] == 0))
                    {
                ...
                draw(nextblock, new Tuple<int, int>(priority[n - 1].Item2, priority[n - 1].Item3));
